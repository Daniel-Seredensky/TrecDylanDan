...
* `notes.txt`: Supplementary notes or observations
...
This tool was developed by one of the participating teams at Siena College in the "Detection, Retrieval, and Augmented Generation for Understanding News" (DRAGUN) track of TREC 2025. The purpose is to explore whether debate-style reasoning can improve model-generated assessments of news credibility.

---

Let me know if you'd like to add setup instructions for LangFlow or example input files.
